...
public class No3_3 {
    public static void main(String[] args) {
        ...
        try {
            srcStream = new BufferedInputStream(new FileInputStream(srcFile));  // input stream
            destStream = new BufferedOutputStream(new FileOutputStream(destFile));  // output stream
